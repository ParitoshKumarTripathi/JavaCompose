...
public class Color {
    ...
    private static int backgroundColorLight = 0xFFE3F3FF;
    ...
    public static void init(Context context) {
        if (!isInitialized) {
            ...
            backgroundColorLight = res.getColor(android.R.color.system_neutral2_50, context.getTheme());
            backgroundColorDark = res.getColor(android.R.color.system_accent2_800, context.getTheme());
